			...
			<div id="page-wrapper">
				...
				<!-- Banner -->
					...
					<img src="images/저탄고집v6.png" width="200px" >
							<p>건의사항</p>
						<form id="contactForm" action="${pageContext.request.contextPath }/noticeEditDo" method="POST">
							<input type="hidden" name="notiNo" value="${notice.notiNo }">
							
							<div class="mb-3">
								<label for="inputTitle">제목</label>
								<input class="form-control" id="inputTitle" type="text" name="notiTitle" value="${notice.notiTitle }"/>
							</div>
							<div class="mb-3">
