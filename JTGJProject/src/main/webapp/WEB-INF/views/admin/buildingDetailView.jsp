			...
			<div class="inner">
				<div class="container">
					...
					<div class="d-flex justify-content-end mar-buttom ">
						<a class="m-right" href="<c:url value="/buildingEditView?bldNm=${detail.bldNm }&purposeKindName=${detail.purposeKindName }" />">
							<button class="btn btn-primary btn-xl">수정 하기</button>
						</a>
						
						<a href="${pageContext.request.contextPath }/buildingView">
							<button class="btn btn-primary btn-xl">건축물 목록으로 돌아가기</button>
						</a>
					</div>
				</div>
			</div>
