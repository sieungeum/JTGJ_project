			...
			<div class="container">
				...
				<form id="contactFrom" action="<c:url value="/buildingAddDo" />" method="POST">
					...
					<div class="d-flex justify-content-end mar-buttom ">
						<button class="btn btn-primary btn-xl m-right" type="submit">추가</button>
						<a class="btn btn-primary btn-xl a-sor" href="${pageContext.request.contextPath }/buildingView">돌아가기</a>
					</div>
				</form>
			</div>
